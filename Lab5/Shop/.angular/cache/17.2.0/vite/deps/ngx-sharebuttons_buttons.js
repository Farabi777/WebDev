import {
  FaIconComponent,
  FontAwesomeModule
} from "./chunk-GDM3WIT2.js";
import {
  Meta
} from "./chunk-237HRUMH.js";
import {
  AsyncPipe,
  CommonModule,
  DOCUMENT,
...
function ShareButton_div_2_div_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty("icon", ctx_r2.icon || _r0.icon)("fixedWidth", true);
  }
}
function ShareButton_div_2_div_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const _r0 = ɵɵreference(1);
    ɵɵadvance();
    ɵɵtextInterpolate1(" ", ctx_r3.text || _r0.text, " ");
  }
}
function ShareButton_div_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const _r0 = ɵɵreference(1);
    ɵɵadvance();
    ɵɵproperty("ngIf", ctx_r1.showIcon && _r0.icon);
    ɵɵadvance();
...
_ShareButton.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 3,
  vars: 14,
  consts: [["type", "button", 1, "sb-wrapper", 3, "shareButton", "url", "image", "title", "description", "tags", "redirectUrl", "autoSetMeta", "disabled", "opened", "closed"], ["btn", "shareButton"], ["class", "sb-content", 4, "ngIf"], [1, "sb-content"], ["class", "sb-icon", 4, "ngIf"], ["class", "sb-text", 4, "ngIf"], [1, "sb-icon"], [3, "icon", "fixedWidth"], [1, "sb-text"]],
...
function ShareButtons_div_0_share_button_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = ɵɵnextContext(2);
    ɵɵproperty("button", button_r4)("theme", ctx_r2.theme)("url", ctx_r2.url)("title", ctx_r2.title)("description", ctx_r2.description)("image", ctx_r2.image)("tags", ctx_r2.tags)("redirectUrl", ctx_r2.redirectUrl)("autoSetMeta", ctx_r2.autoSetMeta)("showIcon", ctx_r2.showIcon)("showText", ctx_r2.showText)("disabled", ctx_r2.disabled);
  }
}
function ShareButtons_div_0_expand_button_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("toggle", function ShareButtons_div_0_expand_button_2_Template_expand_button_toggle_0_listener($event) {
      ...
      return ɵɵresetView(ctx_r8.updateState({
        expanded: $event
      }));
    });
    ɵɵelementEnd();
  ...
  if (rf & 2) {
    const state_r1 = ɵɵnextContext().$implicit;
    const ctx_r3 = ɵɵnextContext();
    ɵɵclassMapInterpolate1("sb-button sb-", ctx_r3.theme, "");
    ɵɵproperty("expanded", state_r1.expanded)("moreIcon", state_r1.moreIcon)("lessIcon", state_r1.lessIcon)("moreAriaLabel", state_r1.moreAriaLabel)("lessAriaLabel", state_r1.lessAriaLabel);
  }
}
function ShareButtons_div_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵclassMapInterpolate1("sb-group sb-", ctx_r0.theme, "");
    ɵɵadvance();
    ɵɵproperty("ngForOf", state_r1.selectedButtons);
    ɵɵadvance();
    ɵɵproperty("ngIf", state_r1.shownCount < state_r1.userButtons.length);
  }
}
